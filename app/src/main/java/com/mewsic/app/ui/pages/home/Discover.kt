...
fun Discover(
        ...
        HomepageContentRow(icon = { Icon(painter = painterResource(R.drawable.ic_youtube_logo), contentDescription = null) }, title = "TEST CONTENT", content = testHomepageContent.shuffled())
}